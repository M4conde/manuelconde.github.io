...
define( "RECIPIENT_NAME", "Manuel Conde" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "bebopsdesign@gmail.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Website Visitor" ); //UPDATE THIS TO YOUR SUBJECT
